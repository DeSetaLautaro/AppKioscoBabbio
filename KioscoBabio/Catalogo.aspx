<%@ Page Title="" Language="C#" MasterPageFile="~/Menú.Master" AutoEventWireup="true" CodeBehind="Catalogo.aspx.cs" Inherits="KioscoBabio.Catalogo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">


    <%-- Al cargar la pagina pone la estrella amarilla para los favoritos, y deja solo el contorno para los no favoritos --%>
    <script type="text/javascript">
        ...
        function handleWindowLoad() {
            ...
            cards.forEach(card => {
                ...
                const isFavorite = faveados.includes(cardData.id)
    ...
    <script type="text/javascript">
        function toggleFavorite(container, button) {
            ...
            var isFavorite = pathIcon.style.fill === 'yellow'; // Verifica si el botón está marcado como favorito
            var idArticulo = container.querySelector('#producto').getAttribute('data-id');
            var userId = <%= Session["UserId"] %>; // Obtén el ID de usuario desde la sesión
